...
public interface SchoolBusiness extends com.idega.business.IBOService
{
 ...
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,int p2,java.sql.Timestamp p3,int p4) throws java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(com.idega.block.school.data.SchoolClass p0,com.idega.user.data.User p1) throws java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,int p2,java.sql.Timestamp p3,int p4,java.lang.String p5) throws java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,int p2,java.sql.Timestamp p3,java.sql.Timestamp p4,int p5,java.lang.String p6) throws java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,java.sql.Timestamp p2,int p3) throws java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,java.sql.Timestamp p2,int p3,java.lang.String p4) throws java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,java.sql.Timestamp p2,java.sql.Timestamp p3,int p4,java.lang.String p5) throws java.rmi.RemoteException;
