...
public interface SchoolBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.Collection findStudentsInSchoolByDate(int p0,int p1,java.sql.Date p2, boolean getNotYetActive)throws java.rmi.RemoteException, java.rmi.RemoteException;
