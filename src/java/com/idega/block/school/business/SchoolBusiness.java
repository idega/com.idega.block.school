...
public interface SchoolBusiness extends IBOService {
	 ...
	 */
	public SchoolDepartmentHome getSchoolDepartmentHome()
	 ...
	 */
	public Collection getDepartments(School school) throws RemoteException,
	 ...
	 */
	public void removeDepartment(SchoolDepartment schDep)
			throws RemoveException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#addSchoolUsr
	 */
	public void addSchoolUsr(int schDep_id, SchoolUser schUser)
	 ...
	 */
	public void removeSchoolUsr(int schDep_id, SchoolUser schUser)
			throws FinderException, RemoteException,
			IDORemoveRelationshipException, RemoteException;
	 ...
	 */
	public Collection findAllSchoolsByAreaAndTypeAndYear(int areaID,
			int typeID, int yearID) throws RemoteException;
	 ...
	 */
	public Collection findAllSchoolsBySubAreaAndTypes(int subarea,
			Collection types) throws RemoteException;
	 ...
	 */
	public School createSchool(String name, String address, String zipcode,
			String ziparea, String phone, int school_type, Object communePK)
			throws RemoteException, RemoteException;
	 ...
	 */
	public School createSchool(String name, String address, String zipcode,
			String ziparea, String phone, int area_id, int[] sch_types,
			Object communePK) throws RemoteException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#createSchool
	 */
	public School createSchool(String name, String info, String address,
			String zipcode, String ziparea, String phone, String keycode,
			String latitude, String longitude, int area_id, int[] type_ids,
			Object communePK) throws RemoteException, RemoteException;
	...
	public School createSchool(String name, String info, String address,
			String zipcode, String ziparea, String phone, String keycode,
			String latitude, String longitude, int area_id, int[] type_ids,
			int[] year_ids, Object communePK) throws RemoteException,
			RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeSchool
	 */
	public School storeSchool(int id, String name, String info, String address,
			String zipcode, String ziparea, String phone, String keycode,
			String latitude, String longitude, int area_id, int[] type_ids,
			int[] year_ids, Object communePK) throws RemoteException,
			RemoteException;
	...
	public School storeSchool(int id, String name, String info, String address,
			String zipcode, String ziparea, String phone, String keycode,
			String latitude, String longitude, int area_id, int[] type_ids,
			int[] year_ids, Object communePK, String providerStringId)
			throws RemoteException, RemoteException;
	...
	public School storeSchool(int id, String name, String info, String address,
			String zipcode, String ziparea, String phone, String keycode,
			String latitude, String longitude, int area_id, int sub_area_id,
			int[] type_ids, int[] year_ids, String organizationNumber,
			String extraProviderId, String managementTypeId,
			Date terminationDate, Object communePK, int countryId,
			Boolean centralizedAdministration, Boolean invisibleForCitizen)
			throws RemoteException, RemoteException;
	...
	public School storeSchool(int id, String name, String info, String address,
			...
			Date terminationDate, Object communePK, int countryId,
			Boolean centralizedAdministration, Boolean invisibleForCitizen,
			String providerStringId) throws RemoteException, RemoteException;
	...
	public School storeSchool(int id, String name, String info, String address,
			...
			Date terminationDate, Object communePK, int countryId,
			Boolean centralizedAdministration, Boolean invisibleForCitizen,
			String providerStringId, Boolean sortByBirthdate)
			throws RemoteException, RemoteException;
	 ...
	 */
	public Map getSchoolAndSchoolTypeRelatedSchoolCourses(School school,
			Object schoolTypeId) throws RemoteException;
	 ...
	 */
	public Group getNewSchoolGroup(String name, String info)
			throws RemoteException, RemoteException;
	 ...
	 */
	public boolean hasEditPermission(User user, School school)
			throws RemoteException, RemoteException;
	 ...
	 */
	public SchoolClass storeSchoolClass(String schoolClassName, School school,
			SchoolYear year, SchoolSeason season) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeSchoolClassMember
	 */
	public SchoolClassMember storeSchoolClassMember(SchoolClass sClass,
	...
	public Group getRootSchoolAdministratorGroup() throws CreateException,
			FinderException, RemoteException, RemoteException;
	 ...
	 */
	public Group getRootSchoolOtherCommuneAdministratorGroup()
	 ...
	 */
	public Group getRootHighSchoolOtherCommuneAdministratorGroup()
			throws CreateException, FinderException, RemoteException,
			RemoteException;
	 ...
	 */
	public Group getRootProviderOtherCommuneAdministratorGroup()
			throws CreateException, FinderException, RemoteException,
			RemoteException;
	 ...
	 */
	public void storeSchoolYearPlaces(int id, int school_id,
			int school_year_id, int places) throws RemoteException,
			RemoteException;
	 ...
	 */
	public Collection findSchoolYearsBySchoolCategory(String schoolCategory)
			throws FinderException, RemoteException;
	 ...
	 */
	public void storeSchoolYear(int pk, String name, int schoolTypeId,
			String category, String info, String localizedKey, int age)
			throws RemoteException, RemoteException;
	 ...
	 */
	public Collection getSchoolTypesForCategory(SchoolCategory category,
			boolean showFreetimeTypes) throws RemoteException;
	 ...
	 */
	public void storeSchoolType(int id, String name, String info,
			String category, String locKey, int maxAge, boolean isFreetimeType,
			boolean isFamilyFreetimeType, int order) throws RemoteException,
			RemoteException;
	...
	public void storeSchoolType(int id, String name, String info,
			String category, String locKey, int maxAge, boolean isFreetimeType,
			boolean isFamilyFreetimeType, int order, String typeStringId)
			throws RemoteException, RemoteException;
	 ...
	 */
	public SchoolSeason getCurrentSchoolSeason(SchoolCategory category)
			throws FinderException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#getNextSchoolSeason
	 */
	public SchoolSeason getNextSchoolSeason(SchoolCategory category)
			throws FinderException, RemoteException;
	 ...
	 */
	public void storeSchoolSeason(int id, String name, Date start, Date end,
			Date choiceStartDate, Date choiceEndDate, String category)
			throws RemoteException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findClassMemberInClass
	 */
	public SchoolClassMember findClassMemberInClass(int studentID,
			int schoolClassID) throws RemoteException;
	 ...
	 */
	public SchoolClassMember findByStudentAndSchoolAndSeason(int userID,
			int schoolID, int seasonID) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findByStudentAndSeason
	 */
	public SchoolClassMember findByStudentAndSeason(User user,
			SchoolSeason season) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findByStudentAndSeason
	 */
	public SchoolClassMember findByStudentAndSeason(SchoolClassMember student,
			SchoolSeason season) throws RemoteException;
	 ...
	 */
	public Collection findSubGroupPlacements(int studentID, int schoolID,
			int seasonID) throws FinderException, RemoteException;
	...
	public Collection findClassMemberInAdultEducation(int studentID,
			int schoolID) throws RemoteException;
	 ...
	 */
	public Collection findStudentsInClassAndYear(int studentClassID,
	 ...
	 */
	public Collection findSchoolByDate(int schoolID, int schoolClassID,
			Date date) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findStudentsInSchoolByDate
	 */
	public Collection findStudentsInSchoolByDate(int schoolID,
			int schoolClassID, Date date, boolean showNotYetActive)
			throws RemoteException;
	 ...
	 */
	public Collection findStudentsInSchoolByDate(int schoolID,
			int schoolClassID, String schoolCategory, Date date,
			boolean showNotYetActive) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findStudentsInSchoolByDateChildcare
	 */
	public Collection findStudentsInSchoolByDateChildcare(int schoolID,
			int schoolClassID, String schoolCategory, Date date,
			boolean showNotYetActive) throws RemoteException;
	 ...
	 */
	public Collection findStudentsInSchoolByDate(int schoolID,
			int schoolClassID, Date date) throws RemoteException;
	 ...
	 */
	public Collection findStudentsBySchoolAndSeasonAndYear(int schoolID,
			int seasonID, int yearID) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findStudentsBySchoolAndSeasonAndYear
	 */
	public Collection findStudentsBySchoolAndSeasonAndYear(School school,
			SchoolSeason season, SchoolYear year) throws RemoteException;
	 ...
	 */
	public void removeSchoolClassMemberFromClass(int studentID,
			int schoolClassID) throws RemoteException;
	 ...
	 */
	public SchoolClassMember storeSchoolClassMemberCC(int studentID,
			int schoolClassID, int schoolTypeID, Timestamp registerDate,
			int registrator) throws RemoteException;
	...
	public SchoolClassMember storeSchoolClassMemberCC(int studentID,
			int schoolClassID, int schoolTypeID, Timestamp registerDate,
			int registrator, String notes) throws RemoteException;
	...
	public SchoolClassMember storeSchoolClassMemberCC(int studentID,
			int schoolClassID, int schoolTypeID, Timestamp registerDate,
			Timestamp removedDate, int registrator, String notes)
			throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeSchoolClassMember
	 */
	public SchoolClassMember storeSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, int registrator) throws RemoteException;
	...
	public SchoolClassMember storeSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, Timestamp removedDate, int registrator,
			String notes) throws RemoteException;
	...
	public SchoolClassMember storeSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, Timestamp removedDate, int registrator,
			String notes, String language) throws RemoteException;
	...
	public SchoolClassMember storeSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, Timestamp removedDate, int registrator,
			String notes, String language, int studyPathID, int handicraftId)
			throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeNewSchoolClassMember
	 */
	public SchoolClassMember storeNewSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, int registrator, String notes,
	...
	public SchoolClassMember storeNewSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, Timestamp removedDate, int registrator,
			String notes, String sLanguage) throws RemoteException;
	 ...
	 */
	public Collection findSchoolClassesBySchoolAndCategory(int schoolID,
	 ...
	 */
	public Collection findSchoolClassesBySchoolAndSeason(int schoolID,
			int schoolSeasonID) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findSchoolClassesBySchoolAndYear
	 */
	public Collection findSchoolClassesBySchoolAndYear(int schoolID,
			int schoolYearID) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findSchoolClassesBySchoolAndSeasonAndYear
	 */
	public Collection findSchoolClassesBySchoolAndSeasonAndYear(int schoolID,
			int schoolSeasonID, int schoolYearID, boolean showSubGroups)
			throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findSchoolClassesBySchoolAndSchoolTypeAndSeason
	 */
	public Collection findSchoolClassesBySchoolAndSchoolTypeAndSeason(
			int schoolID, int schoolTypeID, int schoolSeasonID,
			Boolean showSubGroups, Boolean showNonSeasonGroups)
			throws RemoteException;
	 ...
	 */
	public Collection findSchoolClassesBySchoolAndSeasonAndYear(int schoolID,
			int schoolSeasonID, int schoolYearID) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findSchoolClassesBySchoolAndSeasonAndYearAndStudyPath
	 */
	public Collection findSchoolClassesBySchoolAndSeasonAndYearAndStudyPath(
			int schoolID, int schoolSeasonID, int schoolYearID, int studyPathID)
			throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findSchoolClassesBySchoolAndSeasonAndYears
	 */
	public Collection findSchoolClassesBySchoolAndSeasonAndYears(int schoolID,
			int schoolSeasonID, String[] schoolYearIDs) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findSchoolClassesBySchoolAndSeasonAndYears
	 */
	public Collection findSchoolClassesBySchoolAndSeasonAndYears(int schoolID,
			int schoolSeasonID, String[] schoolYearIDs, boolean showSubGroups)
			throws RemoteException;
	 ...
	 */
	public Collection findSchoolClassesBySchoolAndTeacher(int schoolID,
			int teacherID) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findSchoolClassesBySchoolAndSeasonAndTeacher
	 */
	public Collection findSchoolClassesBySchoolAndSeasonAndTeacher(
			int schoolID, int schoolSeasonID, int teacherID)
			throws RemoteException;
	 ...
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeSchoolClass
	 */
	public SchoolClass storeSchoolClass(int schoolClassID, String className,
			int schoolID, int schoolTypeID, int seasonID,
			String[] schoolYearIDs, String[] teacherIDs) throws RemoteException;
	...
	public SchoolClass storeSchoolClass(int schoolClassID, String className,
			int schoolID, int schoolTypeID, int seasonID,
			String[] schoolYearIDs, String[] teacherIDs, String[] studyPathIDs)
			throws RemoteException;
	...
	public SchoolClass storeSchoolClass(int schoolClassID, String className,
			int schoolID, int schoolTypeID, int seasonID,
			String[] schoolYearIDs, String[] teacherIDs, String[] studyPathIDs,
			String groupStringId) throws RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeSchoolClass
	 */
	public SchoolClass storeSchoolClass(int schoolClassID, String className,
			int schoolID, int schoolSeasonID, int schoolYearID, int teacherID)
			throws RemoteException;
	 ...
	 */
	public void storeSchoolArea(int id, String name, String info, String city,
			SchoolCategory category) throws RemoteException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeSchoolSubArea
	 */
	public void storeSchoolSubArea(int id, String name, int areaid)
			throws RemoteException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#storeSchoolDepartment
	 */
	public void storeSchoolDepartment(String description, String phone,
			int schoolID, int schDepID) throws RemoteException, RemoteException;
	 ...
	 * @see com.idega.block.school.business.SchoolBusinessBean#setProperty
	 */
	public void setProperty(School school, String propertyName,
	 ...
	 */
	public void addToSchoolClassMemberLog(SchoolClassMember member,
			Date endDate, User performer) throws IllegalArgumentException,
			RemoteException;
	 ...
	 */
	public void addToSchoolClassMemberLog(SchoolClassMember member,
			SchoolClass schoolClass, Date endDate, User performer)
			throws IllegalArgumentException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#addToSchoolClassMemberLog
	 */
	public void addToSchoolClassMemberLog(int schoolClassMemberID,
			int schoolClassID, Date startDate, Date endDate, User performer)
			throws IllegalArgumentException, RemoteException;
	 ...
	 */
	public void addToSchoolClassMemberLog(SchoolClassMember member,
			SchoolClass schoolClass, Date startDate, Date endDate,
			User performer) throws IllegalArgumentException, RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#hasActivePlacement
	 */
	public boolean hasActivePlacement(int studentId, int schoolId,
			SchoolCategory category) throws RemoteException;
