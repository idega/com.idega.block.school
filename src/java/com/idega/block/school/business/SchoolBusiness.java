...
public interface SchoolBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.Collection findAllCentralizedAdministrated()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection findAllCentralizedAdministratedByType(java.util.Collection p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection findAllSchClMemberInvoiceIntervalTypes()throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection findAllSchoolTypesForChildCare()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection findAllSchoolTypesForSchool()throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection findAllSchoolYears()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection findAllSchoolYearsByAge(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection findAllSchoolsByAreaAndTypeAndYear(int p0,int p1,int p2)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection findAllSchoolsByType(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember findByStudentAndSchoolAndSeason(int p0,int p1,int p2)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.school.data.SchoolClassMember findByStudentAndSeason(com.idega.block.school.data.SchoolClassMember p0,com.idega.block.school.data.SchoolSeason p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember findByStudentAndSeason(int p0,int p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection findClassMember(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection findClassMemberInChildCare(int p0,int p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection findStudentsInSchool(int p0,int p1)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection findStudentsInSchoolByDate(int p0,int p1,java.sql.Date p2,boolean p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection findStudentsInSchoolByDate(int p0,int p1,java.sql.Date p2)throws java.rmi.RemoteException,java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.school.data.SchoolCategory getCategoryChildcare()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolCategory getCategoryCollege()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolCategory getCategoryElementarySchool()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolCategory getCategoryHighSchool()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolCategory getCategoryUniversity()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.lang.String getChildCareSchoolCategory()throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.lang.String getElementarySchoolSchoolCategory()throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public java.util.Collection getSchoolCategories()throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.school.data.SchoolManagementTypeHome getSchoolManagementTypeHome()throws java.rmi.RemoteException, java.rmi.RemoteException;
 public java.util.Collection getSchoolManagementTypes()throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public void removeProvider(int p0)throws java.rmi.RemoteException,javax.ejb.RemoveException, java.rmi.RemoteException;
 ...
 public void removeSchoolYear(int p0)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.school.data.SchoolClass storeSchoolClass(int p0,java.lang.String p1,int p2,int p3,int p4,int p5)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.school.data.SchoolClass storeSchoolClass(java.lang.String p0,com.idega.block.school.data.School p1,com.idega.block.school.data.SchoolYear p2,com.idega.block.school.data.SchoolSeason p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,int p2,java.sql.Timestamp p3,int p4,java.lang.String p5)throws java.rmi.RemoteException, java.rmi.RemoteException;
 ...
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,int p2,java.sql.Timestamp p3,int p4)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,int p2,java.sql.Timestamp p3,java.sql.Timestamp p4,int p5,java.lang.String p6)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,java.sql.Timestamp p2,int p3)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,java.sql.Timestamp p2,int p3,java.lang.String p4)throws java.rmi.RemoteException, java.rmi.RemoteException;
 public com.idega.block.school.data.SchoolClassMember storeSchoolClassMember(int p0,int p1,java.sql.Timestamp p2,java.sql.Timestamp p3,int p4,java.lang.String p5)throws java.rmi.RemoteException, java.rmi.RemoteException;
