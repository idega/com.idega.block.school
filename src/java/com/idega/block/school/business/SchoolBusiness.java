...
public interface SchoolBusiness extends IBOService {
	...
	public Collection findAllSchoolsByAreaAndTypeAndYear(int areaID,
			int typeID, int yearID) throws java.rmi.RemoteException;
	...
	public Collection findAllSchoolsBySubAreaAndTypes(int subarea,
			Collection types) throws java.rmi.RemoteException;
	 ...
	 */
	public java.util.Collection findAllCentralizedAdministratedByType(
			Collection typeIds) throws java.rmi.RemoteException;
	...
	public School storeSchool(int id, String name, String info, String address,
			...
			java.sql.Date terminationDate, Object communePK, int countryId,
	...
	public School storeSchool(int id, String name, String info, String address,
			...
			java.sql.Date terminationDate, Object communePK, int countryId,
			Boolean centralizedAdministration, Boolean invisibleForCitizen,
			String providerStringId) throws RemoteException;
	...
	public Map getSchoolAndSchoolTypeRelatedSchoolCourses(School school,
			Object schoolTypeId) throws java.rmi.RemoteException;
	...
	public SchoolClass storeSchoolClass(String schoolClassName, School school,
			SchoolYear year, SchoolSeason season)
			throws java.rmi.RemoteException;
	...
	public void storeSchoolYearPlaces(int id, int school_id,
			int school_year_id, int places) throws java.rmi.RemoteException;
	...
	public Collection getSchoolTypesForCategory(SchoolCategory category,
			boolean showFreetimeTypes) throws java.rmi.RemoteException;
	...
	public void storeSchoolType(int id, String name, String info,
			...
			boolean isFamilyFreetimeType, int order)
			throws java.rmi.RemoteException;
	...
	public SchoolClassMember findByStudentAndSchoolAndSeason(int userID,
			int schoolID, int seasonID) throws java.rmi.RemoteException;

	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#findByStudentAndSeason
	 */
	public SchoolClassMember findByStudentAndSeason(User user,
			SchoolSeason season) throws java.rmi.RemoteException;
	...
	public Collection findSubGroupPlacements(int studentID, int schoolID,
			int seasonID) throws FinderException, java.rmi.RemoteException;
	...
	public Collection findClassMemberInAdultEducation(int studentID,
			int schoolID) throws java.rmi.RemoteException;
	...
	public Collection findStudentsInClassAndYear(int studentClassID,
			int schoolYearID) throws java.rmi.RemoteException;
	...
	public Collection findStudentsInSchoolByDate(int schoolID,
			int schoolClassID, java.sql.Date date, boolean showNotYetActive)
			throws java.rmi.RemoteException;
	 ...
	 */
	public Collection findStudentsInSchoolByDate(int schoolID,
			int schoolClassID, String schoolCategory, java.sql.Date date,
	 ...
	 */
	public Collection findStudentsInSchoolByDate(int schoolID,
			int schoolClassID, java.sql.Date date)
			throws java.rmi.RemoteException;
	...
	public Collection findStudentsBySchoolAndSeasonAndYear(int schoolID,
			int seasonID, int yearID) throws java.rmi.RemoteException;
	...
	/**
	 * @see com.idega.block.school.business.SchoolBusinessBean#deleteSchoolClassMemberEntry
	 */
	...
	public SchoolClassMember storeSchoolClassMemberCC(int studentID,
			...
			int registrator) throws java.rmi.RemoteException;
	...
	public SchoolClassMember storeSchoolClassMemberCC(int studentID,
			int schoolClassID, int schoolTypeID, Timestamp registerDate,
			int registrator, String notes) throws java.rmi.RemoteException;
	...
	public SchoolClassMember storeSchoolClassMember(int studentID,
			...
			String notes) throws java.rmi.RemoteException;
	...
	public SchoolClassMember storeSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, Timestamp removedDate, int registrator,
			String notes, String language) throws java.rmi.RemoteException;
	...
	public SchoolClassMember storeSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, Timestamp removedDate, int registrator,
			String notes, String language, int studyPathID)
			throws java.rmi.RemoteException;
	...
	public SchoolClassMember storeNewSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, int registrator, String notes,
			String languageID) throws java.rmi.RemoteException;
	...
	public SchoolClassMember storeNewSchoolClassMember(int studentID,
			int schoolClassID, int schoolYearID, int schoolTypeID,
			Timestamp registerDate, Timestamp removedDate, int registrator,
			String notes, String sLanguage) throws java.rmi.RemoteException;
	...
	public Collection findSchoolClassesBySchoolAndSeason(int schoolID,
			int schoolSeasonID) throws java.rmi.RemoteException;
	 ...
	 */
	public Collection findSchoolClassesBySchoolAndSeasonAndYear(int schoolID,
			int schoolSeasonID, int schoolYearID)
			throws java.rmi.RemoteException;
	...
	public Collection findSchoolClassesBySchoolAndSeasonAndYears(int schoolID,
			int schoolSeasonID, String[] schoolYearIDs)
			throws java.rmi.RemoteException;
	...
	public Collection findSchoolClassesBySchoolAndTeacher(int schoolID,
			int teacherID) throws java.rmi.RemoteException;
	...
	public SchoolClass storeSchoolClass(int schoolClassID, String className,
			...
			String[] schoolYearIDs, String[] teacherIDs)
			throws java.rmi.RemoteException;
	...
	public SchoolClass storeSchoolClass(int schoolClassID, String className,
			int schoolID, int schoolTypeID, int seasonID,
			String[] schoolYearIDs, String[] teacherIDs, String[] studyPathIDs,
			String groupStringId) throws java.rmi.RemoteException;
	...
	public void storeSchoolDepartment(String description, String phone,
			int schoolID, int schDepID) throws RemoteException;
	...
	public void setProperty(School school, String propertyName,
			String propertyValue) throws java.rmi.RemoteException;
