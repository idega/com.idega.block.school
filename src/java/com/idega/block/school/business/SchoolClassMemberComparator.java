 ...
 */
public class SchoolClassMemberComparator implements Comparator<SchoolClassMember> {
  ...
  private Comparator<User> genderComparatorForUser = null;

  /**
   * If a special gender comparator is used (e.g. for swedish applications)
   * */
  static public Comparator<SchoolClassMember> getComparatorSortByUseGenderComparator(int sortBy, Comparator<User> genderComparatorForUser, Locale locale, UserBusiness business, Map<Integer, User> students) {
   ...
   * @return
   */
  static public Comparator<SchoolClassMember> getComparatorWithGenderComparatorSortBy(int sortBy, Locale locale, UserBusiness business, Map<Integer, User> students) {
   ...
   * @return
   */
  static public Comparator<SchoolClassMember> getComparatorSortBy(int sortBy, Locale locale, UserBusiness business, Map<Integer, User> students) {
	  return new SchoolClassMemberComparator(sortBy, getSimpleGenderComparator(), locale, business, students);
  }

  static public Comparator<SchoolClassMember> getComparatorSortByName(Locale locale, UserBusiness business, Map<Integer, User> students) {
   ...
   */
	...
	static private Comparator<User> getSimpleGenderComparator() {
	 ...
	 * @return
	 */
	static private Comparator<User> getAdvancedGenderComparator() {
		try {
			return new Comparator<User>() {
				...
				@Override
				public int compare(User o1, User o2) {
					boolean isFemale1 = (femaleID == (o1.getGenderID()));
					boolean isFemale2 = (femaleID == o2.getGenderID());
	...
	private SchoolClassMemberComparator(int sortBy, Locale locale, UserBusiness business, Map<Integer, User> students) {
	  	this.sortBy = sortBy;
	  	this.locale = locale;
	...
	private SchoolClassMemberComparator(int sortBy, Comparator<User> genderComparator, Locale locale, UserBusiness business, Map<Integer, User> students) {
	 ...
	 */
	@Override
	public int compare(SchoolClassMember o1, SchoolClassMember o2) {
	...
	public int nameSort(SchoolClassMember o1, SchoolClassMember o2) {
	...
	public int lastNameSort(SchoolClassMember o1, SchoolClassMember o2) {
		User p1 = this.students.get(new Integer(o1.getClassMemberId()));
		User p2 = this.students.get(new Integer(o2.getClassMemberId()));
	...
	public int firstNameSort(SchoolClassMember o1, SchoolClassMember o2) {
		User p1 = this.students.get(new Integer(o1.getClassMemberId()));
		User p2 = this.students.get(new Integer(o2.getClassMemberId()));
	...
	public int genderSort(SchoolClassMember o1, SchoolClassMember o2) {
		User p1 = this.students.get(new Integer(o1.getClassMemberId()));
		User p2 = this.students.get(new Integer(o2.getClassMemberId()));
	...
	public int addressSort(Object o1, Object o2) throws RemoteException {
		User u1 = this.students.get(new Integer((((SchoolClassMember)o1).getClassMemberId())));
		User u2 = this.students.get(new Integer((((SchoolClassMember)o2).getClassMemberId())));
	...
	public int personalIDSort(Object o1, Object o2) {
		User p1 = this.students.get(new Integer((((SchoolClassMember)o1).getClassMemberId())));
		User p2 = this.students.get(new Integer((((SchoolClassMember)o2).getClassMemberId())));
	...
	public int languageSort(SchoolClassMember o1, SchoolClassMember o2) {
		SchoolClassMember p1 = o1;
		SchoolClassMember p2 = o2;
	...
	public int ageSort(SchoolClassMember o1, SchoolClassMember o2) {
		User p1 = this.students.get(new Integer(o1.getClassMemberId()));
		User p2 = this.students.get(new Integer(o2.getClassMemberId()));
