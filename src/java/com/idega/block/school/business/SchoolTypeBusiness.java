...
public interface SchoolTypeBusiness extends com.idega.business.IBOService
{
 ...
 public java.util.Collection findAllSchoolTypesInCategory(int p0) throws java.rmi.RemoteException;
 public java.util.Collection findAllSchoolTypes() throws java.rmi.RemoteException;
 public void storeSchoolType(int p0,java.lang.String p1,java.lang.String p2,int p3,java.lang.String p4)throws java.rmi.RemoteException, java.rmi.RemoteException;
