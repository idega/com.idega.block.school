...
public interface SchoolYearPlaces extends com.idega.data.IDOEntity
{
 ...
 public int getPlaces() throws java.rmi.RemoteException;
 public void setPlaces(int p0) throws java.rmi.RemoteException;
}
