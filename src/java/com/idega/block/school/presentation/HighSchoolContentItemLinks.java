...
//		}
		...
		if ((address != null || zipArea != null || zipCode != null || phone != null || fax != null || email != null)) {
			if (useBreak) {
				++row;
...
//		Moved the management type here  (Kelly)
		...
		if (webPage != null) {
			...
			Link link = new Link(getHeader(_iwrb.getLocalizedString("school.web_page","Web Page")), webPage);
