...
/**
 * 
 * Last modified: $Date: 2005/01/04 13:49:52 $ by $Author: laddi $
 * 
...
public class SchoolYearSelectorCollectionHandler implements RemoteScriptCollection {
	...
	public RemoteScriptingResults getResults(IWContext iwc) {
		...
		return handleYearUpdate(sourceName, sourceID);
	}

	private RemoteScriptingResults handleYearUpdate(String sourceName, String typeID) {
		if (typeID != null) {
