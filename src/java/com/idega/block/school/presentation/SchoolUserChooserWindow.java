/*
 * $Id: SchoolUserChooserWindow.java,v 1.8 2006/03/23 11:47:58 laddi Exp $
...
public class SchoolUserChooserWindow extends UserChooserWindow {
	...
	protected void init(IWContext iwc) {
		...
		try {
			...
			int[] userTypes = { SchoolUserBusinessBean.USER_TYPE_HEADMASTER, SchoolUserBusinessBean.USER_TYPE_ASSISTANT_HEADMASTER, SchoolUserBusinessBean.USER_TYPE_IB_COORDINATOR, SchoolUserBusinessBean.USER_TYPE_STUDY_AND_WORK_COUNCEL, SchoolUserBusinessBean.USER_TYPE_TEACHER, SchoolUserBusinessBean.USER_TYPE_WEB_ADMIN, SchoolUserBusinessBean.USER_TYPE_SCHOOL_MASTER, SchoolUserBusinessBean.USER_TYPE_CONTACT_PERSON, SchoolUserBusinessBean.USER_TYPE_EXPEDITION, SchoolUserBusinessBean.USER_TYPE_PROJECT_MANAGER };
